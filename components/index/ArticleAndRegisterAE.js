          ...
          <Row gutter={[25, 25]} justify="center" align="middle">
            <Col xs={24} sm={24} md={12} lg={12} xl={12} xxl={12}>
              <Typography.Title level={3}>
                <Divider
                  type="vertical"
                  style={{ height: 30, width: 3, background: "red" }}
                />
                Sprout Online
              </Typography.Title>
              <Card
                cover={<img src="/images/index-mission/2.jpg" alt="mission1" />}
              >
                <a className="news-text" href="" target="_blank">
                  <Typography.Paragraph
                    ellipsis={{
                      rows: 2,
                      suffix: (
                        <p style={{ color: "#0082e6" }}>อ่านเพิ่มเติม</p>
                      ),
                    }}
                  >
                    ตลาด Sprout
            ...
            <Col xs={24} sm={24} md={12} lg={12} xl={12} xxl={12}>
              ...
              <Card
                cover={<img src="/images/index-mission/1.jpg" alt="mission1" />}
              >
                <a className="news-text" href="" target="_blank">
                  <Typography.Paragraph
                    ellipsis={{

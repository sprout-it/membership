...
const LayoutComponent = ({ children }) => {
  return (
    ...
    >
      <Row align="middle">
        ...
        >
          <Row justify="end" align="middle" wrap={false}>
            <Link href="/login">
              <Button className="login-button" type="ghost">
                Sign In
              </Button>
            </Link>
            <Link href="/register">
              <Button className="signup-button" type="primary">
                Sign Up
              </Button>
            </Link>
          </Row>
      ...
      <Header className="header">
        <nav className="navbar">
          ...
          <ul className="navbar-menu">
            ...
            <li>
              <Link href="/marketing">
                <a className="active">Marketing</a>
              </Link>
            </li>
            <li>
              <Link href="/logistic">
                <a className="active">Logistic</a>
              </Link>
            </li>
            <li>
              <Link href="/it">
                <a className="active">IT</a>
              </Link>
            </li>
            <li>
              <Link href="/financial">
                <a className="active">Financial</a>
              </Link>
            </li>
          </ul>
        </nav>
      ...
      <Footer style={{ margin: 0, backgroundColor: "#35b729", height: "100%" }}>
        <Row justify="center" style={{ color: "#fff", height: "100%" }}>
          <Col xs={24} sm={24} md={24} lg={24} xl={24} xxl={24}>
            ...
            <Row>09 5517 9516</Row>
            <Row>@sproutcounter24</Row>
            <Row>admin@sproutstory.co</Row>
            <Row>https://www.facebook.com/sproutfoodT77/</Row>
          </Col>
        </Row>
      </Footer>
    </Layout>
